...
def test_import_real_run_html_extracts_visible_candidates_and_run_evidence(
        ...
        "entries": [
            {
                ...
                "message": {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "please use the memoryledger skill to store all the gained knowledge",
                        }
                    ],
                },
            },
            {
                ...
                "message": {
                    "role": "assistant",
                    "content": [
                        {"type": "thinking", "text": "hidden thinking memoryledger"}
                    ],
                },
            },
            {
                ...
                "message": {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "error: MANUAL_FILE: Refusing to overwrite manual file: AGENTS.md",
                        }
                    ],
                },
            },
            {
                ...
                "message": {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "Created and accepted memories. Backup created by adoption: AGENTS.md.memoryledger-adopt-1.bak",
                        }
                    ],
                },
            },
            {
                ...
                "message": {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "Total entries: 173 Assistant messages: 81 Tool result messages: 74",
                        }
                    ],
                },
            },
    ...
    path.write_text(f'<script id="session-data">{encoded}</script>')
    data = json.loads(
        invoke_ok(runner, ["import", "run-html", "--file", str(path), "--json"]).output
    )
